...
namespace Eapproval.Controllers
{
    ...
    public class NotesController : ControllerBase
    {
        ...
        public NotesController(UsersService usersService, Notifier notifier, NotesService notesService, HelperClass helperClass, TicketsService ticketService)
        {
        ...
        public async Task<IActionResult> MakeMentions(IFormCollection data)
        {
            ...
            foreach (var mention in mentions)
            {
                ...
                _notifier.InsertNotification(time, "Notification", user, notificationUser, ticket.Id, mentions, "mention");
            }
