...
namespace Eapproval.Controllers;
    ...
    public class MainController : Controller
    {
        ...
        MailTicket  _mailTicket;

        public MainController(MailTicket mailTicket, TicketMailer ticketMailer, FileHandler fileHandler, TicketsService ticketsService, TeamsService teamsService, UsersService usersService, UserApi userApi, LocationService locationService)
        {
